from .interpersonal_reactive_index_heb_qclm import interpersonal_reactive_index_heb_qclm_list
...
if interpersonal_reactive_index_heb_qclm_list:
    question_class_nli = interpersonal_reactive_index_heb_qclm_list[0]
    task_name, questionnaire_name = get_questionnaire_info(question_class_nli)
    for clm_question in interpersonal_reactive_index_heb_qclm_list:
